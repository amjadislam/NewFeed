...
function* fetchData(action) {
  try {
    ...
    const URL = `https://newsapi.org/v2/everything?q=${type}&sortBy=publishedAt&apiKey=${App_Constants.NEWS_API_KEY}&pageSize=10&page=${page}`;
    const sendData = {
      method: 'GET',
      url: URL,
    };
    console.log('===> ~ function*fetchData ~ sendData', sendData);
